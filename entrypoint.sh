...
if [ "$1" = 'mattermost' ]; then
  ...
  then
    ...
    # export MM_SQLSETTINGS_DATASOURCE="root:mysql@tcp(127.0.0.1:3306)/mattermost?charset=utf8mb4,utf8&readTimeout=30s&writeTimeout=30s"
    export MM_SQLSETTINGS_DATASOURCE="$MM_USERNAME:$ENCODED_PASSWORD@tcp($DB_HOST:$DB_PORT_NUMBER)/$MM_DBNAME?charset=utf8mb4,utf8&readTimeout=30s&writeTimeout=30s"
    echo OK
  else
